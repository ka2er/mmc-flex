...
package business.commands {
	...
	public class DelSettingCommand extends SequenceCommand implements ICommand, IResponder {
		...
		override public function execute(e:CairngormEvent):void
		{
			...
			new SettingsDelegate( this ).del(SettingEvent(e).setting, SettingEvent(e).setting_name)			
		}
		...
		public function fault(f : Object):void {
			Alert.show("DelSettingCommand : Erreur lors de la suppression")	
		}
	}
}